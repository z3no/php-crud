...
<section class="d-flex">
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-primary stretched-link">Go to students</a>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-primary stretched-link">Go to teachers</a>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-primary stretched-link">Go to groups</a>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="#" class="btn btn-primary stretched-link">Go to campuses</a>
        </div>
    </div>
